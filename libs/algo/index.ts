 ...
 */
export function quickSort(data: ArrayNumber): ArrayNumber {
  if (data.length <= 1) {
    return data;
  }
 ...
 */
export function bubbleSort(data: ArrayNumber): ArrayNumber {
  for (let i = 0; i < data.length; i++) {
 ...
 */
export function selectionSort(data: ArrayNumber): ArrayNumber {
  for (let i = 0; i < data.length; i++) {
    let index = i; // 1
    let swap = false;
 ...
 */
export function insertionSort(data: ArrayNumber): ArrayNumber {
 ...
 */
export function mergeSort(data: ArrayNumber): ArrayNumber {
  if (data.length <= 2) {
    if (data.length === 1) {
      return data;
    } else {
